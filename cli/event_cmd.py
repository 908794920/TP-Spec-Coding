...
def add_event_subparsers(event_parser) -> None:
    ...
    # 显式管理员恢复模式（只走当前五态 record-first runtime）
    p_sync.add_argument("--admin-recovery", action="store_true", help="personal mode: explicit managed recovery through current five-state runtime")
