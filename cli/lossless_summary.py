# -*- coding: utf-8 -*-
"""V5.2.8 B-14 lossless-summary 仅无损的可回溯摘要（B-17 C7-P1~P10）。
...
def add_lossless_summary_subparsers(subparsers) -> None:
    p = subparsers.add_parser(
        "lossless-summary",
        help="V5.2.8 B-14 lossless reversible summary: content classify + sentinel protect + fold (no state change)",
    )
