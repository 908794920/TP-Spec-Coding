#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""TP-Spec-Coding V5.2.6 CLI 统一入口。
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # v5.2.6 Autonomous Maintenance：用户级 Profile 与隔离自治控制面。
    autonomy_cmd.add_autonomy_subparsers(subparsers)

    # V5.2.6 Wiki 标准化：代码理解层的确定性扫描/规划/质量门/基线提交。
    wiki_commands.add_wiki_subparsers(subparsers)

    # V5.2.6 Knowledge 标准化：长期知识、证据、FTS 投影、外部接入与定时维护。
