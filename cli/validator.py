# -*- coding: utf-8 -*-
"""V5.3.2 phase-aware artifact validator.
...
def validate_artifacts(
    ...
    *,
    ...
    if mode == "handoff":
        raise ValueError(
            "legacy long-state handoff validation is retired in v5.3.2; "
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m cli.validator", description="V5.3.2 phase-aware artifact validator")
