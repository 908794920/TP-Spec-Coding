# -*- coding: utf-8 -*-
"""V5.3.4 可信事件注册表（Final Hardening 单一来源）。

依据：《V5.3.4 Final Hardening Invariant 修复任务》Task 1（§3）与《V5.3.4
...
EVENT_POLICIES: Dict[str, Dict[str, Any]] = {
    ...
    # V5.3.4 Record-first verification is a trusted fact but no longer a state gate.
