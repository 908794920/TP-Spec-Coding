...
def test_v523_is_single_active_contract_and_autonomy_surface_is_shipped():
    ...
    for path in [
        ...
        BASE/"skills/tp-autonomy-setup/SKILL.md",
        BASE/"skills/tp-autonomy-cycle/SKILL.md",
        BASE/"skills/tp-autonomy-review/SKILL.md",
        BASE/"skills/tp-autonomy-integrate/SKILL.md",
