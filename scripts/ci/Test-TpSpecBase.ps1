<#
.SYNOPSIS
V5.2.7 unified offline test entry.
...
-Mode Full   : active V5.2.7 release gate only. Historical compatibility is covered by migration tests, not an active runtime mode.
