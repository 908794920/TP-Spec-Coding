<#
.SYNOPSIS
V5.2.0 P1 unified offline test entry (plan §5 B-02).
...
-Mode Full   : active V5.2.0 release gate only.
-Mode LegacyV510 : frozen prior-contract archive compatibility diagnostics; failures do not make the active V5.2.0 gate red.
...
if ($Mode -eq 'Full') {
    # Active V5.2.0 release gate.  Frozen V5.1.0 suites are intentionally not
